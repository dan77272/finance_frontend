...
export default function Navbar() {
    ...
    async function handleSignOut() {
        // Optional: Implement a /logout endpoint on your backend to clear the cookie
    ...
    return (
        <nav className="bg-green-600 w-full fixed top-0 left-0 z-50 h-16" aria-label="Main Navigation">
            ...
            {mobileMenuOpen && (
                <div className="md:hidden absolute bg-green-600 w-full">
